...
require_once 'view/vip/vip.view.php';
...
class VipController {
    ...
    public function __CONSTRUCT() {
        $this->model = new VIP();
        $this->vista = new VipView();
    }

    public function Index() {
        var_dump($_SESSION);
        $empresa = $this->model->Obtener_Empresa($_SESSION['empresa']);
        $this->vista->View($empresa);
    }
    ...
    public function Perfil() {
        $datos = $this->model->Cargar_Perfil($_SESSION['usuario']);
        $this->vista->Profile($datos);
    }
